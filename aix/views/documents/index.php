...
<div class="container">
                        ...
                        <div>
                            <div class="card border-0 bg-primary-100 mr-3 position-static">
                                <div class="p-3 d-flex align-items-center justify-content-between">
                                    <i class="fa fa-fw fa-robot fa-lg text-primary-600"></i>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card h-100 position-relative" data-toggle="tooltip" title="<?= l('documents.widget.this_month') ?>">
                    <div class="card-body d-flex">
                        <div>
                            <div class="card border-0 bg-primary-100 mr-3 position-static">
                                <div class="p-3 d-flex align-items-center justify-content-between">
                                    <i class="fa fa-fw fa-keyboard fa-lg text-primary-600"></i>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card h-100 position-relative" data-toggle="tooltip" title="<?= l('documents.widget.this_month') ?>">
                    <div class="card-body d-flex">
                        <div>
                            <div class="card border-0 bg-primary-100 mr-3 position-static">
                                <div class="p-3 d-flex align-items-center justify-content-between">
                                    <i class="fa fa-fw fa-feather fa-lg text-primary-600"></i>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('documents.header') ?></h1>
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                <?php if(($this->user->plan_settings->documents_limit != -1 && $data->total_documents >= $this->user->plan_settings->documents_limit) || ($this->user->plan_settings->words_per_month_limit != -1 && $data->available_words <= 0)): ?>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                        ...
                        <form action="" method="get" role="form">
                            ...
                            <div class="form-group px-4">
                                <label for="filters_type" class="small"><?= l('documents.type') ?></label>
                                <select name="type" id="filters_type" class="form-control form-control-sm">
                                    ...
                                    <?php foreach($data->ai_types as $key => $value): ?>
                                        <option value="<?= $key ?>" <?= isset($data->filters->filters['type']) && $data->filters->filters['type'] == $key ? 'selected="selected"' : null ?>><?= l('documents.type.' . $key) ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
            ...
            <table class="table table-custom">
                ...
                <?php foreach($data->documents as $row): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <i class="<?= $data->ai_types[$row->type]['icon'] ?> fa-fw fa-sm mr-1"></i> <?= l('documents.type.' . $row->type) ?>
                        </td>
